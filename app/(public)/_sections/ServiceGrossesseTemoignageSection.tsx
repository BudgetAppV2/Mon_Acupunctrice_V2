...
export default function ServiceGrossesseTemoignageSection() {
  ...
  return (
    <section className="bg-white py-[68px] md:py-[104px] px-5 md:px-8">
      {/* TODO Judith: remplacer par un vrai temoignage (en attente clarification OAQ) */}
      <div ref={containerRef} className="max-w-[780px] mx-auto relative">
        ...
        <blockquote className="ml-2 md:ml-6">
          <p ref={quoteTextRef} className="font-public-serif text-[22px] md:text-[28px] leading-[1.5] text-public-text-dark italic" style={{ willChange: 'transform, opacity' }}>
            Chaque s&eacute;ance est profond&eacute;ment apaisante. Judith transmet avec beaucoup de douceur son amour pour tout ce qui entoure la grossesse et la naissance.
          </p>
          <div ref={signatureRef} className="mt-6 flex items-center gap-3" style={{ willChange: 'transform, opacity' }}>
            ...
            <div>
              <cite className="not-italic font-medium text-public-text-dark text-[15px]">Patiente accompagn&eacute;e</cite>
