    ...
    <section className="cta-bg-shift text-white py-[68px] md:py-[88px] px-5 md:px-8 text-center relative overflow-hidden">
      ...
      <Reveal y={56} duration={1.1} delay={0.2} className="max-w-[620px] mx-auto relative z-10">
        ...
        <p className="text-[16px] italic opacity-90 mb-8 font-public-serif">
          L&rsquo;acupuncture sociale, c&rsquo;est votre porte d&rsquo;entr&eacute;e vers un soin accessible, de qualit&eacute;, et sans jugement. Venez comme vous &ecirc;tes.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4 items-center">
          <MagneticButton range={120} strength={0.4}>
            <div className="shimmer-cta rounded-md">
              <CtaButton variant="white" size="lg" href="https://www.gorendezvous.com/lasourceensoi?companyId=104074&eids=175708">R&eacute;server une s&eacute;ance sociale</CtaButton>
            </div>
          </MagneticButton>
