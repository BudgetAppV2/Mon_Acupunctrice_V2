...
import type { StylePreset } from '@/lib/editor-v2/types';
import { ANIMATION_TYPES, FONT_FAMILIES } from '@/lib/editor-v2/controlOptions';
import { XMarkIcon, ArrowUturnLeftIcon } from '@heroicons/react/24/outline';

export default function ControlPanel() {
  const { globalPreset, updateGlobalField, applyGlobalToAll, blocks, selectedBlockId, updateBlock, resetBlockOverrides, selectBlock } = useEditorV2Store();
