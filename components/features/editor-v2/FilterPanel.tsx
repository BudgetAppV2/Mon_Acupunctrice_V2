...
import { useEditorV2Store, getActiveVideoClip } from '@/lib/store/useEditorV2Store';
import { FILTERS } from '@/lib/editor-v2/filters';

export default function FilterPanel() {
  const { filterId, setFilter, setClipFilter, thumbnailUrl, tracks, currentTime, selectedItemId, filterIntensity, setFilterIntensity } = useEditorV2Store();
