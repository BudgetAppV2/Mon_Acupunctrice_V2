...
import { useEditorV2Store, getVideoTrack, getSubtitleTrack } from '@/lib/store/useEditorV2Store';
...
export default function MiniScrubber() {
  const { currentTime, duration, setCurrentTime, tracks } = useEditorV2Store();
