...
export const CONTENT_STYLES: { value: ContentStyle; label: string; color: string }[] = [
  { value: 'enseigner', label: 'Enseigner', color: '#60A5FA' },
  { value: 'connecter', label: 'Connecter', color: '#4ADE80' },
  { value: 'aider', label: 'Aider', color: '#FBBF24' },
  { value: 'inspirer', label: 'Inspirer', color: '#C084FC' },
];
